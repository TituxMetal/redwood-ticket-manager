...
import { type DbAuthHandlerOptions, type UserType, DbAuthHandler } from '@redwoodjs/auth-dbauth-api'
...
export const handler = async (event: APIGatewayProxyEvent, context: Context) => {
  ...
  const signupOptions: DbAuthHandlerOptions<UserType, UserAttributes>['signup'] = {
    ...
    handler: ({ username, hashedPassword, salt, userAttributes: userAttributes }) => {
      // console.log('signup', username, hashedPassword, salt, userAttributes)
